...
- name: Create openshift cluster
  azure_rm_openshiftmanagedcluster:
    ...
    location: "eastus"
    cluster_profile:
      resource_group_id: "/subscriptions/xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx/resourceGroups/clusterResourceGroup"
      domain: "mydomain"
    service_principal_profile:
    ...
    worker_profiles:
      - vm_size : "Standard_D4s_v3"
        subnet_id : "/subscriptions/xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx/resourceGroups/myResourceGroup/Microsoft.Network/virtualNetworks/myVnet/subnets/worker"
        disk_size : 128
        count : 3
    master_profile:
      vm_size : "Standard_D8s_v3"
      subnet_id: "/subscriptions/xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx/resourceGroups/myResourceGroup/providers/Microsoft.Network/virtualNetworks/myVnet/subnets/master"
    ...
    ingress_profiles:
      ...
      contains:
        visibility:
          ...
          sample: Public
        name:
          description: name of the ingress profile
          returned: always
          type: str
          sample: default
        ip:
